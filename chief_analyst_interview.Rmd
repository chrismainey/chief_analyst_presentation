...
As you've no doubt seen from my application, I'm Patient Safety Lead - System Analysis and Delivery with NHS England and Improvement. I'm ax experienced analyst, data scientist and statistician, used to lead NHS data teams.  I'm a senior fellow in the NHS-R community and keen to help the profession move forward.

Thanks for the opportunity to present, and interview today.
As the brief was to present two projects that demonstrate my expertise.  I'm committed to using modern techniques, and embracing open source approaches.  In part to demonstrate this, the presentation is written in Rmarkdown, visulisations codes and code provided on GitHub.
...
<br><br>
### 2. Re-imagining standardised mortality ratio (SMR) surveillance
...
Patient safety movement is reasonably new, established in the 80 through the like of Harvard medical practice study, and the reading, or clinical audit of patient notes and reflections on harm.  Often likened to high-risk industries, and incident reporting was proted over from them, but fairly different in healthcare.

+ National Reporting and Learning System (NRLS) is the national repository for incident data

+ Desire to compare organisations, and often to 'point the finger', but this is actually at odds with the Patient Safety disciplin - about encouraging reporitng to learn.

+ Still desire to understand reporting patterns, but clinical review is main way to use signal.

+ My project was to examine staitstical modelling approaches for these data.
...
+ HED interactive 'module' allowing - NHSEI prevented launch of this, but techniques now being built for NHSEI
