...
Presentation and code available for: **https://github.com/chrismainey/chief_analyst_presentation**
...
+ My PhD Project: [thesis available here](https://discovery.ucl.ac.uk/id/eprint/10094736/)
...
+ Patient Safety movement in England has encourage national incident reporting (NRLS)
 ...
 + Harvard Medical Practice study, 'Too Err is Human', 'An organisation with a memory'
...
+ Desire to compare behaviour across organisations despite this
 + Develop national indicator with appropriate risk adjustment
 + Change over time?
...
+ "Ground-clearing" exercise - Literature review
  + Strengthened view on free-text being main signal
...
+ Only quantitative approach is 'counting'
...
+ Recommendations for modelling shared with organisations.
 + NHSD now investiating some of methods for SHMI.
 + NHSEI
 
+ Creation of `FunnelPlotR` R package, availble on CRAN and donated to NHS-R community.
...
+ When comparing hospital mortality, it is common to adjust for "case-mix."

+ Although it attempts to reduce confounding, it is at the cost of complexity.
...
+ Commonly measures are:
  ...
  + [Dr Foster Hospital Standardised Mortality Ratio (HSMR)](https://www.nhs.uk/NHSEngland/Hospitalmortalityrates/Documents/090424%20MS(H)%20-%20NHS%20Choices%20HSMR%20Publication%20-%20Presentation%20-%20Annex%20C.pdf)
